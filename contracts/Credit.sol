...
//         require(
//             block.timestamp >=
//                 loan.startTimestamp + loan.durationInDays * 1 days,
//             "Loan is not yet due"
//         );
//         require(
//             msg.value ==
//                 loan.amount + ((loan.amount * loan.interestRate) / 100),
//             "Amount sent must be equal to the monthly amount (e.g. 112 BUSD)"
//         );

//         loan.paidBack = true;

//         // string new_rating = loanRating.getNewRating();

//         // nftContract.makeAnNFT(msg.sender, new_rating);
//     }
// }
